...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed">
      <nav className="grid grid-flow-col-dense w-full bg-emerald-700 py-2 md:py-0">
        <div className="w-auto h-full relative">
          <button onClick={toggleSidebar} type="button" className="md:absolute md:inset-y-1 md:left-0 md:mr-4 p-2 ml-4 mt-2 md:mt-0 text-sm text-white rounded-lg" aria-controls="navbar-hamburger" aria-expanded="false">
        ...
        <div className="w-auto h-full my-auto py-2 mr-2 text-right">
