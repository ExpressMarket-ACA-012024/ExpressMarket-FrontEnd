           ...
           <div className="relative h-48 w-36">
            ...
            <div className="flex items-center justify-between px-4 py-2">
                <div className="flex items-center">
                    <button
                        className="px-2 py-1 font-normal text-white bg-green-500 rounded-l hover:bg-green-700"
                    ...
                    <button
                        className="px-2 py-1 font-normal text-white bg-green-500 rounded-r hover:bg-green-700"
                ...
                <button
                    className="px-2 py-1 font-normal text-white bg-green-500 rounded hover:bg-green-700"
                    onClick={addToCart}
                >
                    {addedToCart ? 'Agregado!' : (
                        <>
                            <svg className="inline-block w-6 h-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
